...
$$
\max_{\pi_{t-}}
\; \mathbb{E}[r_t | \mathcal{F}_{t-1}]^\top \pi_{t-}
- w_{t-} (\pi_{t-}-G_{t-1}\pi_{t-1})^\top
\mathbb{E}[\Lambda_{t-}|\mathcal{F}_{t-1}]
...
\mathbf{1}^\top \pi_{t-} &= 1 \\
\sqrt{\pi_{t-}^\top \mathbb{E}[\Sigma_t|\mathcal{F}_{t-1}] \pi_{t-}}
&\le Var(S&P500)
\end{aligned}
$$
